...
<body>
	...
	<fieldset>
	<div id="legend">
    	<h3 align="center"><strong>회원가입 수정</strong></h3>
    </div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="email" id="t_email" name="email" placeholder="이메일"	class="form-control input-sm" value="${memberVO.email}">
		</div>
	</div>
	...
	<div class="control-group">
    	...
    	<div class="controls">
    		<input type="password" id="t_pwd" name="pwd" class="form-control input-sm" value="${memberVO.pwd}" >
    	</div>
    </div>
    <div class="control-group">
		<i class="fa fa-key" aria-hidden="true"></i>
    	...
    	<div class="controls">
    		<input type="password" id="t_pwd_confirm" name="pwd_confirm" class="form-control input-sm" value="${memberVO.pwd_confirm}" >
    	</div>
    </div>
    <br>
    </div>
	 ...
	 <div class="control-group">
	 	...
	 	<input type="text" id="t_name" name="name" class="form-control input-sm" value="${memberVO.name}" >
	 </div>
    ...
    <div class="control-group">
    	...
    	<label>생일</label>
    	<input type="date" id="t_birth" name="birth" class="form-control" value="${memberVO.birth}" >
    </div>
    
    <div class="control-group">
    	<i class="fa fa-mobile" aria-hidden="true"></i>
    	<label>전화번호</label>
    	<input type="text" id="t_tel" name="tel" class="form-control input-sm" value="${memberVO.tel}" >
    </div>
    <br>
    </div>
